...
export declare const createUpdateStepwise: (tolerance: number) => import('./types').TUpdateFunction<
    import('./interfaces').IUpdateVector & {
...
>;
export declare const setTimingsrcWithCustomUpdateFunction: <UpdateVectorWithCustomState extends import('./interfaces').IUpdateVector>(
    mediaElement: HTMLMediaElement,
    timingObject: import('timing-object').ITimingObject,
    updateFunction: import('./types').TUpdateFunction<UpdateVectorWithCustomState>,
...
export declare const setTimingsrc: (
    mediaElement: HTMLMediaElement,
    timingObject: import('timing-object').ITimingObject,
    prepareTimingStateVector?: import('./types').TPrepareTimingStateVectorFunction | null,
    prepareUpdateVector?: import('./types').TPrepareUpdateVectorFunction | null
